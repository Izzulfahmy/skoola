// file: backend/internal/jenjang/service.go
package jenjang
...
func (s *service) Create(ctx context.Context, schemaName string, input UpsertJenjangInput) (*JenjangPendidikan, error) {
...
func (s *service) GetAll(ctx context.Context, schemaName string) ([]JenjangPendidikan, error) {
	return s.repo.GetAll(ctx, schemaName)
}

func (s *service) GetByID(ctx context.Context, schemaName string, id int) (*JenjangPendidikan, error) {
	return s.repo.GetByID(ctx, schemaName, id)
}

func (s *service) Update(ctx context.Context, schemaName string, id int, input UpsertJenjangInput) error {
	if err := s.validate.Struct(input); err != nil {
