// file: backend/internal/jenisujian/service.go
package jenisujian
...
func (s *service) Create(ctx context.Context, schemaName string, input UpsertJenisUjianInput) (*JenisUjian, error) {
...
func (s *service) GetAll(ctx context.Context, schemaName string) ([]JenisUjian, error) {
	return s.repo.GetAll(ctx, schemaName)
}

func (s *service) GetByID(ctx context.Context, schemaName string, id int) (*JenisUjian, error) {
	return s.repo.GetByID(ctx, schemaName, id)
}

func (s *service) Update(ctx context.Context, schemaName string, id int, input UpsertJenisUjianInput) error {
	if err := s.validate.Struct(input); err != nil {
